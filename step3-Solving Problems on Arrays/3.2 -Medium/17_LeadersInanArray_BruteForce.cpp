/*
  Leaders in an Array Problem Statement: Given an array,
  print all the elements which are leaders.
  A Leader is an element that is greater than 
  all of the elements on its right side in the 
  array.
...
Output:
 7 1 0
Explanation:
 Rightmost element is always a leader. 7 and 1 are greater than
